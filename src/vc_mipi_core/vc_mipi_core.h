...
__u32 vc_core_get_time_per_line_ns(
	struct vc_cam *cam); // Only used by NXP driver
...
#ifdef ENABLE_ADVANCED_CONTROL
int vc_core_set_hmax_overwrite(struct vc_cam *cam,
			       __s32 hmax_overwrite); // Only used by NXP driver
int vc_core_set_vmax_overwrite(struct vc_cam *cam,
			       __s32 vmax_overwrite); // Only used by NXP driver
int vc_core_set_height_offset(struct vc_cam *cam,
			      __s32 vmax_overwrite); // Only used by NXP driver
#endif
